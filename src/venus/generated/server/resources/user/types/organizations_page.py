...
class OrganizationsPage(pydantic.BaseModel):
    ...
    class Validators:
        ...
        Use this class to add validators to the Pydantic model.
            ...
            def validate_organizations(organizations: typing.List[OrganizationId], values: OrganizationsPage.Partial) -> typing.List[OrganizationId]:
                ...

            @OrganizationsPage.Validators.field("next_page")
            def validate_next_page(next_page: typing.Optional[int], values: OrganizationsPage.Partial) -> typing.Optional[int]:
                ...
        """
        ...
        class OrganizationsValidator(typing_extensions.Protocol):
            def __call__(
                self, __v: typing.List[OrganizationId], __values: OrganizationsPage.Partial
            ) -> typing.List[OrganizationId]:
                ...

        class NextPageValidator(typing_extensions.Protocol):
            def __call__(self, __v: typing.Optional[int], __values: OrganizationsPage.Partial) -> typing.Optional[int]:
                ...
