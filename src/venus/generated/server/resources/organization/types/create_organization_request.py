...
class CreateOrganizationRequest(pydantic.BaseModel):
    ...
    class Validators:
        ...
        Use this class to add validators to the Pydantic model.
            ...
            def validate_organization_id(organization_id: OrganizationId, values: CreateOrganizationRequest.Partial) -> OrganizationId:
                ...

            @CreateOrganizationRequest.Validators.field("artifact_read_requires_token")
            def validate_artifact_read_requires_token(artifact_read_requires_token: typing.Optional[bool], values: CreateOrganizationRequest.Partial) -> typing.Optional[bool]:
                ...
        """
        ...
        class OrganizationIdValidator(typing_extensions.Protocol):
            def __call__(self, __v: OrganizationId, __values: CreateOrganizationRequest.Partial) -> OrganizationId:
                ...

        class ArtifactReadRequiresTokenValidator(typing_extensions.Protocol):
            def __call__(
                self, __v: typing.Optional[bool], __values: CreateOrganizationRequest.Partial
