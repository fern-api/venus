...
class Organization(pydantic.BaseModel):
    ...
    def _validate_organization_id(cls, organization_id: OrganizationId) -> OrganizationId:
        for validator in Organization.Validators._organization_id:
    ...
    def _validate_artifact_read_requires_token(cls, artifact_read_requires_token: bool) -> bool:
        for validator in Organization.Validators._artifact_read_requires_token:
        ...
        def field(cls, field_name: str) -> typing.Any:
            def decorator(validator: typing.Any) -> typing.Any:
                if field_name == "organization_id":
                    ...
                    raise RuntimeError("Field does not exist on Organization: " + field_name)
