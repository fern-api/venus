...
class Organization(pydantic.BaseModel):
    ...
    class Validators:
        ...
        Use this class to add validators to the Pydantic model.
            ...
            def validate_artifact_read_requires_token(v: bool, values: Organization.Partial) -> bool:
                ...
        """
        ...
        class OrganizationIdValidator(typing_extensions.Protocol):
            def __call__(self, v: OrganizationId, *, values: Organization.Partial) -> OrganizationId:
                ...
