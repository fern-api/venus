...
from ...commons.types.user_id import UserId as resources_commons_types_user_id_UserId

T_Result = typing.TypeVar("T_Result")


class _Factory:
    def user_id(self, value: resources_commons_types_user_id_UserId) -> UserReference:
...
class UserReference(pydantic.BaseModel):
    ...
    def visit(
        self,
        user_id: typing.Callable[[resources_commons_types_user_id_UserId], T_Result],
...
class _UserReference:
    class UserId(pydantic.BaseModel):
        ...
        user_id: resources_commons_types_user_id_UserId = pydantic.Field(alias="userId")
