...
class CheckRegistryPermissionRequest(pydantic.BaseModel):
    ...
    class Validators:
        ...
        Use this class to add validators to the Pydantic model.
            ...
            def validate_organization_id(organization_id: OrganizationId, values: CheckRegistryPermissionRequest.Partial) -> OrganizationId:
                ...

            @CheckRegistryPermissionRequest.Validators.field("token")
            def validate_token(token: typing.Optional[RegistryToken], values: CheckRegistryPermissionRequest.Partial) -> typing.Optional[RegistryToken]:
                ...
        """
        ...
        class OrganizationIdValidator(typing_extensions.Protocol):
            def __call__(self, __v: OrganizationId, __values: CheckRegistryPermissionRequest.Partial) -> OrganizationId:
                ...

        class TokenValidator(typing_extensions.Protocol):
            def __call__(
                self, __v: typing.Optional[RegistryToken], __values: CheckRegistryPermissionRequest.Partial
