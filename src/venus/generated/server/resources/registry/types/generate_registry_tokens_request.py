...
class GenerateRegistryTokensRequest(pydantic.BaseModel):
    ...
    class Validators:
        ...
        Use this class to add validators to the Pydantic model.
            ...
            def validate_organization_id(organization_id: OrganizationId, values: GenerateRegistryTokensRequest.Partial) -> OrganizationId:
                ...
        """
        ...
        class OrganizationIdValidator(typing_extensions.Protocol):
            def __call__(self, __v: OrganizationId, __values: GenerateRegistryTokensRequest.Partial) -> OrganizationId:
                ...
