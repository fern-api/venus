...
class RegistryTokens(pydantic.BaseModel):
    ...
    class Validators:
        ...
        Use this class to add validators to the Pydantic model.
            ...
            def validate_npm(npm: NpmRegistryToken, values: RegistryTokens.Partial) -> NpmRegistryToken:
                ...

            @RegistryTokens.Validators.field("maven")
            def validate_maven(maven: MavenRegistryToken, values: RegistryTokens.Partial) -> MavenRegistryToken:
                ...
        """
        ...
        class NpmValidator(typing_extensions.Protocol):
            def __call__(self, __v: NpmRegistryToken, __values: RegistryTokens.Partial) -> NpmRegistryToken:
                ...

        class MavenValidator(typing_extensions.Protocol):
            def __call__(self, __v: MavenRegistryToken, __values: RegistryTokens.Partial) -> MavenRegistryToken:
                ...
